...
attribute_group_id number(11) NOT NULL,
...
id number(11) NOT NULL,
attribute_set_id number(11) NOT NULL,
name varchar2(255) NOT NULL
);
...
`id` number(11) NOT NULL,
  ...
  `position` number(11) NOT NULL,
  `children_count` number(11) NOT NULL,
...
`id` number(10) unsigned NOT NULL COMMENT 'Id',
  ...
  `status` varchar2(255) DEFAULT NULL COMMENT 'Order Status',
  `items_count` number(10) unsigned DEFAULT '0' COMMENT 'Items Count',
  `items_quantity` decimal(12,4) DEFAULT '0.0000' COMMENT 'Items Quantity',
  `grand_total` decimal(12,4) DEFAULT '0.0000' COMMENT 'Grand Total',
  `base_grand_total` decimal(12,4) DEFAULT '0.0000' COMMENT 'Base Grand Total',
  `checkout_method` varchar2(255) DEFAULT NULL COMMENT 'Checkout Method',
  `checkout_comment` varchar2(255) DEFAULT NULL,
  `customer_id` number(10) unsigned DEFAULT '0' COMMENT 'Customer Id',
  `customer_group_id` number(10) unsigned DEFAULT '0' COMMENT 'Customer Group Id',
  `customer_email` varchar2(255) DEFAULT NULL COMMENT 'Customer Email',
  `customer_prefix` varchar2(40) DEFAULT NULL COMMENT 'Customer Prefix',
  `customer_firstname` varchar2(255) DEFAULT NULL COMMENT 'Customer Firstname',
  `customer_middlename` varchar2(40) DEFAULT NULL COMMENT 'Customer Middlename',
  `customer_lastname` varchar2(255) DEFAULT NULL COMMENT 'Customer Lastname',
  `customer_suffix` varchar2(40) DEFAULT NULL COMMENT 'Customer Suffix',
  `customer_dob` datetime DEFAULT NULL COMMENT 'Customer Dob',
  `customer_is_guest` smallint(5) unsigned DEFAULT '0' COMMENT 'Customer Is Guest',
  `remote_ip` varchar2(32) DEFAULT NULL COMMENT 'Remote Ip',
  `customer_gender` varchar2(255) DEFAULT NULL COMMENT 'Customer Gender',
  `subtotal` decimal(12,4) DEFAULT NULL COMMENT 'Subtotal',
  `base_subtotal` decimal(12,4) DEFAULT NULL COMMENT 'Base Subtotal',
  `is_changed` number(10) unsigned DEFAULT NULL COMMENT 'Is Changed'
...
`id` number(10) unsigned NOT NULL COMMENT 'Checkout Order Address Id',
  `order_id` number(10) unsigned DEFAULT NULL COMMENT 'Order Id',
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'Created At',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'Updated At',
  `customer_address_id` number(11) DEFAULT NULL COMMENT 'Customer Address Id',
  `quote_address_id` number(11) DEFAULT NULL COMMENT 'Quote Address Id',
  `region_id` number(11) DEFAULT NULL COMMENT 'Region Id',
  `customer_id` number(11) DEFAULT NULL COMMENT 'Customer Id',
  `fax` varchar2(255) DEFAULT NULL COMMENT 'Fax',
  `region` varchar2(255) DEFAULT NULL COMMENT 'Region',
  `postcode` varchar2(255) DEFAULT NULL COMMENT 'Postcode',
  `lastname` varchar2(255) DEFAULT NULL COMMENT 'Lastname',
  `street` varchar2(255) DEFAULT NULL COMMENT 'Street',
  `city` varchar2(255) DEFAULT NULL COMMENT 'City',
  `email` varchar2(255) DEFAULT NULL COMMENT 'Email',
  `telephone` varchar2(255) DEFAULT NULL COMMENT 'Telephone',
  `country_id` varchar2(255) DEFAULT NULL COMMENT 'Country Id',
  `firstname` varchar2(255) DEFAULT NULL COMMENT 'Firstname',
  `address_type` varchar2(255) DEFAULT NULL COMMENT 'Address Type',
  `prefix` varchar2(255) DEFAULT NULL COMMENT 'Prefix',
  `middlename` varchar2(255) DEFAULT NULL COMMENT 'Middlename',
  `suffix` varchar2(255) DEFAULT NULL COMMENT 'Suffix',
  `company` varchar2(255) DEFAULT NULL COMMENT 'Company'
...
`id` number(10) unsigned NOT NULL COMMENT 'Order Item Id',
  `order_id` number(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Order Id',
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'Created At',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'Updated At',
  `product_id` number(10) unsigned DEFAULT NULL COMMENT 'Product Id',
  `attribute_id` number(10) unsigned DEFAULT NULL COMMENT 'Attribute Id',
  `store_id` smallint(5) unsigned DEFAULT NULL COMMENT 'Store Id',
  `parent_id` number(10) unsigned DEFAULT NULL COMMENT 'Parent Item Id',
  `is_virtual` smallint(5) unsigned DEFAULT NULL COMMENT 'Is Virtual',
  `sku` varchar2(255) DEFAULT NULL COMMENT 'Sku',
  `name` varchar2(255) DEFAULT NULL COMMENT 'Name',
  ...
  `product_type` varchar2(255) DEFAULT NULL COMMENT 'Product Type'
...
`id` number(10) unsigned NOT NULL COMMENT 'Payment Method Id',
  `payment_method` varchar2(255) DEFAULT NULL COMMENT 'Payment Method',
  `description` varchar2(255) DEFAULT NULL COMMENT 'Payment Method Description'
...
`id` number(10) unsigned NOT NULL COMMENT 'Checkout Quote Address Id',
  `quote_id` number(10) unsigned DEFAULT NULL COMMENT 'Quote Id',
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'Created At',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'Updated At',
  `customer_address_id` number(11) DEFAULT NULL COMMENT 'Customer Address Id',
  `region_id` number(11) DEFAULT NULL COMMENT 'Region Id',
...
`id` number(10) unsigned NOT NULL COMMENT 'Item Id',
  `quote_id` number(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Quote Id',
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'Created At',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'Updated At',
  `product_id` number(10) unsigned DEFAULT NULL COMMENT 'Product Id',
  `attribute_id` number(10) unsigned DEFAULT NULL COMMENT 'Attribute Id',
...
`id` number(11) NOT NULL,
  `customer_group_id` number(11) DEFAULT NULL,
  `email` varchar2(255) DEFAULT NULL,
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT NULL,
  `is_acive` number(11) DEFAULT NULL
...
`id` number(11) NOT NULL,
  ...
  `tax_class_id` number(11) NOT NULL
...
`id` number(11) NOT NULL,
  `customer_group` number(11) NOT NULL,
  ...
  `street_address1` varchar2(100) NOT NULL,
  `street_address2` varchar2(100) NOT NULL,
  `street_address3` varchar2(100) NOT NULL,
...
`id` number(11) NOT NULL,
  ...
  `sku` varchar2(100) DEFAULT NULL,
  `type` varchar2(100) DEFAULT NULL,
  `has_options` number(11) DEFAULT NULL,
  `required_options` number(11) DEFAULT NULL
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1;
...
`id` number(11) NOT NULL,
  ...
  `URL_key` varchar2(255) NOT NULL,
  `Visibility` number(11) NOT NULL,
...
`id` number(11) NOT NULL,
  `product_id` number(11) NOT NULL,
  `attribute_value_id` number(11) NOT NULL,
...
--
ALTER TABLE `attribute`
MODIFY `id` number(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `attribute_set`
MODIFY `id` number(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `attribute_values`
--
ALTER TABLE `attribute_values`
MODIFY `id` number(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `categories`
--
ALTER TABLE `categories`
MODIFY `id` number(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=20;
--
-- AUTO_INCREMENT for table `category_entity_values`
--
ALTER TABLE `category_entity_values`
MODIFY `id` number(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=15;
--
-- AUTO_INCREMENT for table `category_products`
--
ALTER TABLE `category_products`
MODIFY `id` number(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `checkout_order`
--
ALTER TABLE `checkout_order`
MODIFY `id` number(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT for table `checkout_order_address`
--
ALTER TABLE `checkout_order_address`
MODIFY `id` number(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Checkout Order Address Id';
--
-- AUTO_INCREMENT for table `checkout_order_item`
--
ALTER TABLE `checkout_order_item`
MODIFY `id` number(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Order Item Id';
--
-- AUTO_INCREMENT for table `checkout_payment_methods`
--
ALTER TABLE `checkout_payment_methods`
MODIFY `id` number(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Payment Method Id';
--
...
--
ALTER TABLE `checkout_quote_address`
MODIFY `id` number(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Checkout Quote Address Id';
--
-- AUTO_INCREMENT for table `checkout_quote_item`
--
ALTER TABLE `checkout_quote_item`
MODIFY `id` number(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Item Id';
--
...
--
ALTER TABLE `entities`
MODIFY `id` number(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=41;
--
...
--
ALTER TABLE `product_entity_values`
MODIFY `id` number(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=153;
