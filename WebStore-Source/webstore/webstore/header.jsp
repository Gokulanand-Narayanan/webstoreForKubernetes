			...
			<div ng-controller="navigationController" class="ng-scope">
			    		...
			    		<ul class="dropdown-menu multi-level ng-binding" role="menu" aria-labelledby="dropdownMenu" ng-bind-html="htmlString">
							...
							<li class="dropdown-submenu">
								...
								<ul class="dropdown-menu"><li><a href="home.jsp?cat=5">Mobile</a></li>
									...
									<li><a href="home.jsp?cat=7">Laptops</a></li>
									<li><a href="home.jsp?cat=8">Tablets</a></li>
									<li><a href="home.jsp?cat=9">Camera</a></li>
								</ul>
							</li>
							<li class="dropdown-submenu">
								<a href="home.jsp?cat=10">TVs &amp; Appliances</a>
								<ul class="dropdown-menu">
									<li><a href="home.jsp?cat=11">Television</a></li>
									<li><a href="home.jsp?cat=12">Washing Machine</a></li>
									<li><a href="home.jsp?cat=13">Refrigerators</a></li>
									<li><a href="home.jsp?cat=14">Air Conditioners</a></li>
								</ul>
							</li>
							<li class="dropdown-submenu">
								<a href="home.jsp?cat=15">Home &amp; Furniture</a>
								<ul class="dropdown-menu">
									<li><a href="home.jsp?cat=16">Furniture</a></li>
									<li><a href="home.jsp?cat=17">Lighting</a></li>
									<li><a href="home.jsp?cat=18">Kitchen &amp; Dining</a></li>
								</ul>
							</li>
							<li class="dropdown-submenu">
				...
				<!--	<%if(firstName.equals("Sign In") || firstName.length() == 0){%>
					...
					<%}
						...
						<li ng-hide="logined"><a href=""> Hi <%= firstName %></a></li>
				...
				<div style="float:right" class="userblock">
					...
					<%}
						...
						<div ng-hide="logined" style="color:#fff;"><span style="color:#fff;padding:5px;">Hi</span><a href=""><%= firstName %></a> | <a href="logout.jsp">Logout</a></div>
					<% } %>
